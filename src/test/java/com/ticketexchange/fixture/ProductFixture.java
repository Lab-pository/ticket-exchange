...
public final class ProductFixture {
    ...
    public static ProductRequest 당첨되는_상품_생성_요청() {
        return new ProductRequest(PRODUCT_NAME, NEED_TICKET_COUNT, TOTAL_QUANTITY, START_DATE, END_DATE, FULL_PROBABILITY);
    }

    public static ProductRequest 당첨되지_않는_상품_생성_요청() {
        return new ProductRequest(PRODUCT_NAME, NEED_TICKET_COUNT, TOTAL_QUANTITY, START_DATE, END_DATE, ZERO_PROBABILITY);
    }
}
